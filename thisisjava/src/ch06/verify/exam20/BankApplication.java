	...
	public static void main(String[] args) {
		...
		while(run) {
			...
			case "1": System.out.println("--------");
			          ...
			          //if(accounts[index]==null) accounts[index++]=account;
			...
			case "3": System.out.println("--------");
					  ...
					  for(int i=0;i<accounts.length;i++) {
					    	  ...
					    	  //[account][account][null][null][account][null][null][null][null][null][null]
					      }
					  if(acc==null) System.out.println("해당 번호의 계좌가 없습니다.");
					  */
